 ...
 */
public class GetCfProjectTask extends CommonTask<GetCfProjectParam,GetCfProjectResp> {
    @Override
    protected GetCfProjectResp doInBackground(Object... params) {
        try {
    ...
    @Override
    protected void onPostExecute(GetCfProjectResp response) {
        try {
