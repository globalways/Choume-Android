...
import com.globalways.choume.proto.nano.OutsouringCrowdfunding.PassCfProjectInvestParam;
 ...
 */
public class PassCfProjectInvestTask extends CommonTask<PassCfProjectInvestParam,Common.Response> {
    @Override
    protected Common.Response doInBackground(Object... params) {
        try {
            ...
            return stub.passCfProjectInvest(taskParam);
        } catch (Exception e) {
            e = e;
            return null;
        }
