...
import com.globalways.choume.proto.nano.OutsouringCrowdfunding.CfUserCBConsumeResp;
 ...
 */
public class CfUserCBConsumeTask extends CommonTask<CfUserCBConsumeParam,CfUserCBConsumeResp> {
    @Override
    protected CfUserCBConsumeResp doInBackground(Object... params) {
        try {
    ...
    @Override
    protected void onPostExecute(CfUserCBConsumeResp response) {
        try {
