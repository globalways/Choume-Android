 ...
 */
public class PrepareUserWalletRechargeTask extends CommonTask<UserWallet.PrepareUserWalletRechargeParam,UserWallet.PrepareUserWalletRechargeResp> {
    @Override
    protected UserWallet.PrepareUserWalletRechargeResp doInBackground(Object... params) {
        try {
    ...
    @Override
    protected void onPostExecute(UserWallet.PrepareUserWalletRechargeResp response) {
        try {
