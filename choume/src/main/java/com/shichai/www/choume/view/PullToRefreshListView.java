...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void addFooterView() {
		mEndRootView = mInflater.inflate(R.layout.refresh_listfooter_more, null);
...
//			endingView.setVisibility(View.VISIBLE);
		...
		if (mCanLoadMore) {
			...
			case ENDINT_AUTO_LOAD_DONE:
				if(mIsDatas){
                    ...
                    mEndLoadTipsTextView.setText(R.string.p2refresh_end_no_data);
                }
    ...
    /**
     */
    public void setIsDatas(boolean isDatas){
        this.mIsDatas = isDatas;
        if(!isDatas){
            mEndLoadTipsTextView.setText(R.string.p2refresh_end_no_data);
        }
    }
