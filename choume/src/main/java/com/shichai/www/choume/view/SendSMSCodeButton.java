 ...
 */
public class SendSMSCodeButton extends Button {
    ...
    public void startTickWork() {
        if (mClickBle) {
            ...
            SendSMSCodeButton.this.setText(mDisableString + mDisableTime
                    + Second);
            this.setEnabled(false);
            SendSMSCodeButton.this.setTextColor(mDisableColor);
            initTimerTask();
