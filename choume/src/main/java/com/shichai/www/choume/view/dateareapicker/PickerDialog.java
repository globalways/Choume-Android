...
public class PickerDialog {
	...
	public PickerDialog builder() {
		// 获取Dialog布局
		View view = LayoutInflater.from(context).inflate(
				R.layout.dateareapicker_toast_view_alertdialog, null);
	...
	public PickerDialog setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public PickerDialog setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public PickerDialog setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public PickerDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public PickerDialog setPositiveButton(String text,
	...
	public PickerDialog setNegativeButton(String text,
										   final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");
	...
	private void setLayout() {
		...
		if (!showPosBtn && !showNegBtn) {
			...
			btn_pos.setBackgroundResource(R.drawable.dateareapicker_alertdialog_single_selector);
			btn_pos.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					dialog.dismiss();
		...
		if (showPosBtn && showNegBtn) {
			btn_pos.setVisibility(View.VISIBLE);
			btn_pos.setBackgroundResource(R.drawable.dateareapicker_alertdialog_right_selector);
			btn_neg.setVisibility(View.VISIBLE);
			btn_neg.setBackgroundResource(R.drawable.dateareapicker_alertdialog_left_selector);
		...
		if (!showPosBtn && showNegBtn) {
			btn_neg.setVisibility(View.VISIBLE);
			btn_neg.setBackgroundResource(R.drawable.dateareapicker_alertdialog_single_selector);
		}
	}
