...
package com.shichai.www.choume.view.dateareapicker.wheelcity;
...
import com.shichai.www.choume.view.dateareapicker.wheelcity.adapters.WheelViewAdapter;
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.dateareapicker_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.dateareapicker_wheel_bg);
	}
